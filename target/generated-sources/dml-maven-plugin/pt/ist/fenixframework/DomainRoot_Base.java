...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.myDrive.domain.MyDriveManager> role$$myDriveManager = new pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.myDrive.domain.MyDriveManager>() {
        @Override
        public pt.tecnico.myDrive.domain.MyDriveManager getValue(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base.DO_State)o1.get$obj$state(false)).myDriveManager;
        }
        @Override
        public void setValue(pt.ist.fenixframework.DomainRoot o1, pt.tecnico.myDrive.domain.MyDriveManager o2) {
            ((DomainRoot_Base.DO_State)o1.get$obj$state(true)).myDriveManager = o2;
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.tecnico.myDrive.domain.MyDriveManager,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.tecnico.myDrive.domain.MyDriveManager.role$$rootFenix;
        }
    ...
    private final static class DomainRootHasMyDriveManager {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.myDrive.domain.MyDriveManager> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.myDrive.domain.MyDriveManager>(role$$myDriveManager, "DomainRootHasMyDriveManager");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.myDrive.domain.MyDriveManager> getRelationDomainRootHasMyDriveManager() {
        return DomainRootHasMyDriveManager.relation;
    }
    
    static {
        DomainRootHasMyDriveManager.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasMyDriveManager");
    }
    ...
    public void setMyDriveManager(pt.tecnico.myDrive.domain.MyDriveManager myDriveManager) {
        getRelationDomainRootHasMyDriveManager().add((pt.ist.fenixframework.DomainRoot)this, myDriveManager);
    }
